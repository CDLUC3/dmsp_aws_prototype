...
if ARGV.length >= 3
  ...
  if ARGV[1].to_s.downcase.strip == 'true' || ARGV[2].to_s.downcase.strip == 'true'
    ...
    @fetchable_params = [
      ...
      { template_param_name: 'TypeaheadTableArn', lookup_name: "#{@cf_export_prefix}TypeaheadTableArn" },
      { template_param_name: 'TypeaheadTableName', lookup_name: "#{@cf_export_prefix}TypeaheadTableName" },
      { template_param_name: 'TypeaheadTableStreamArn', lookup_name: "#{@cf_export_prefix}TypeaheadTableStreamArn" },

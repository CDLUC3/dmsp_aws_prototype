...
PACKAGE_NAME = "dmp-hub-cfn"
VERSION = "1.0.0"
TRAVELING_RUBY_VERSION = "20210206-2.4.10"

desc "Package your app with mysql2 for x86_64-linux"
...
namespace :package do
  namespace :linux do
    ...
    # http://d6r77u77i8pq3.cloudfront.net/releases/traveling-ruby-gems-20210206-2.4.10-linux-x86_64/mysql2-0.5.3.tar.gz
  ...
  task :bundle_install do
    ...
    Bundler.with_clean_env do
      sh "cd packaging/tmp && env BUNDLE_IGNORE_CONFIG=1 bundle install --path ../vendor --without test"
    end
    sh "rm -rf packaging/tmp"
...
def create_package(target)
  ...
  sh "cp dmp-hub-cfn.rb #{package_dir}/lib/app/"
  sh "mkdir #{package_dir}/lib/ruby"
  sh "tar -xzf packaging/traveling-ruby-#{TRAVELING_RUBY_VERSION}-#{target}.tar.gz -C #{package_dir}/lib/ruby"
  sh "cp packaging/wrapper.sh #{package_dir}/dmp-hub-cfn"

# -*- encoding: utf-8 -*-
# stub: uc3-dmp-s3 0.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "uc3-dmp-s3".freeze
  s.version = "0.0.1"
  ...
  s.date = "2023-05-16"
  s.description = "Helpers for read/write to S3".freeze
  s.email = ["brian.riley@ucop.edu".freeze]
  s.homepage = "https://github.com/CDLUC3/dmp-hub-cfn/blob/main/src/sam/gems/uc3-dmp-s3".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.7".freeze)
  s.rubygems_version = "3.1.6".freeze
  s.summary = "DMPTool gem that provides general support for accessing the DMPTool S3 Bucket".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<aws-sdk-s3>.freeze, ["~> 1.119"])
    s.add_runtime_dependency(%q<base64>.freeze, ["~> 0.1"])
    s.add_runtime_dependency(%q<cgi>.freeze, ["~> 0.3"])
    ...
    s.add_dependency(%q<aws-sdk-s3>.freeze, ["~> 1.119"])
    s.add_dependency(%q<base64>.freeze, ["~> 0.1"])
    s.add_dependency(%q<cgi>.freeze, ["~> 0.3"])

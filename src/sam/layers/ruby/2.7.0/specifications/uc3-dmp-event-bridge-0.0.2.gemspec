# -*- encoding: utf-8 -*-
# stub: uc3-dmp-event-bridge 0.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "uc3-dmp-event-bridge".freeze
  s.version = "0.0.2"
  ...
  s.date = "2023-06-08"
  s.description = "Helpers for Event Bridge messaging".freeze
  s.email = ["brian.riley@ucop.edu".freeze]
  s.homepage = "https://github.com/CDLUC3/dmp-hub-cfn/blob/main/src/sam/gems/uc3-dmp-event-bridge".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.7".freeze)
  s.rubygems_version = "3.1.6".freeze
  s.summary = "DMPTool gem that provides support for Event Bridge".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<aws-sdk-eventbridge>.freeze, ["~> 1.44"])
    ...
    s.add_dependency(%q<aws-sdk-eventbridge>.freeze, ["~> 1.44"])

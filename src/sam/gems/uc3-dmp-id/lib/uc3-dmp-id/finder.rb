  ...
  class Finder
    ...
    class << self
      ...
      def search_dmps(args:, logger: nil)
        ...
        return _by_owner_org(owner_org: args['owner_org_ror'], client: client, logger: logger) unless args['owner_org_ror'].nil?
        return _by_mod_day(day: args['modification_day'], client: client, logger: logger) unless args['modification_day'].nil?
          ...
          key_conditions: {
            dmphub_owner_id: {
              attribute_value_list: [
                "http://orcid.org/#{owner_id.to_s}",
                "https://orcid.org/#{owner_id.to_s}"
              ],

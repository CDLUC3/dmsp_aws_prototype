...
if ARGV.length >= 3
  ...
  @cf_params = %w[HarvesterRoleArn S3PrivateBucketId LambdaSecurityGroupId DbSecurityGroupId EventBusArn DeadLetterQueueArn]
  ...
  if @run_build || @run_deploy
    ...
    if @run_deploy
      ...
      if @use_docker
        ...
        s3_arn = fetch_cf_output(name: "#{@env}-S3PrivateBucketArn")
